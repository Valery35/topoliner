...
![Вершина соседа лежит на ребре, но узла там нет. Границы совпадают
геометрически, а вершинность разная.](figures/missing_node_ru.png)
...
**Для линий** есть своя группа 3: проверка и очистка. Плюс линии принимают
сшивка 1.05, вставка узлов 1.06 и упрощение 2.01. Контроль сборки 1.07 тоже
принимает линии.
