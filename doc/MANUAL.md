...
Отдельно печатается потолок: величина, выше которой допуск брать не следует,
потому что он схлопнет короткие рёбра и узкие объекты. Считается по пятому
...
**Узлы** несут степень, то есть число сходящихся дуг. Степень 1 это висячий
...
линии с признаком того, с чем они граничат. Здесь помимо линий выдаются узлы
