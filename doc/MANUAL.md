...
![Объект уже допуска схлопнулся бы, поэтому остаётся нетронутым.](figures/narrow.png)
...
геометрически, а вершинность разная.](figures/missing_node.png)
...
остаётся человеку.](figures/line_ends.png)
...
![Перекрытие оценивается шириной, а не площадью.](figures/overlap_width.png)
...
![Зазор меньше допуска закрывается сведением вершин.](figures/snap.png)
...
![Группа собирается в одно тело либо распадается на части.](figures/assembly.png)
...
![Упрощение по отдельности разводит общую границу.](figures/simplify.png)
...
![Обычный перевод даёт две совпадающие линии, инструмент 2.02 одну.](figures/shared_border.png)
