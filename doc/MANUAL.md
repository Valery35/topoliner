...
## 5. Инструмент 1.01 Проверка топологии полигонов
...
## 6. Инструмент 1.02 Проверка топологии линий
...
## 7. Инструмент 1.03 Очистка топологии полигонов
...
## 8. Инструмент 1.04 Очистка топологии линий
...
## 9. Инструмент 1.05 Сшивка узлов и вершин
...
## 10. Инструмент 1.06 Вставка недостающих узлов
...
## 11. Инструмент 1.07 Контроль сборки по атрибуту
...
## 12. Инструмент 2.01 Топологическое упрощение
...
## 12а. Инструмент 2.02 Границы полигонов линиями
...
## 13. Что решено по общим границам
...
## 16. Заливка результата обратно в MSSQL
...
## 18. Справочник параметров

Таблицы для быстрого поиска: что означает поле в диалоге и что оно меняет.
Подробные объяснения смысла остались в разделах инструментов, здесь только
сводка.

Пометка **необязательный** означает, что параметр можно оставить пустым.
...
|---|---|---|
| Входной слой (полигоны или линии) | - | |
| Допуск упрощения | 1 | Предельное отклонение упрощённой линии от исходной |
...
## 19. Справочник полей выходных слоёв
