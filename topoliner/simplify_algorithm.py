...
class TopologySimplifyAlgorithm(QgsProcessingAlgorithm):
    ...
    def initAlgorithm(self, config=None):
        ...
        p = QgsProcessingParameterEnum(
            ...
            defaultValue=0)
        p.setHelp(
            "Дуглас-Пекер меряет отклонение вершины от хорды. Он держит углы\n"
        ...
        p = QgsProcessingParameterNumber(
            self.SMOOTH, tr("Сглаживание, количество проходов (0 - без сглаживания)"),
        ...
        p.setHelp(
            ...
            "Каждый проход примерно удваивает количество вершин, обычно хватает\n"
            "одного или двух."
        )
        self.addParameter(p)
