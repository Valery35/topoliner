...
def tolerance_hint(findings, tolerance, edge_p05=None, min_width=None):
    ...
    min_width  характерная малая ширина кольца, если известна. Берётся
               не минимум, а низкий процентиль: одно волосяное кольцо
               не должно диктовать допуск для всего слоя
